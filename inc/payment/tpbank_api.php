<?php
/* 
* Lấy access token tpb 
*/
function get_tpb_token($username,$password){
...
/* 
* Lấy lịch sử giao dịch tài khoản tpb
*/
function get_tpb_history($token, $stk_tpbank, $ngay_bat_dau_check, $ngay_ket_thuc_check){
