(function () {
    ...
    SliderCaptcha.Author = 'nam@obx.vn';
    SliderCaptcha.DEFAULTS = {
        ...
        sliderR: 9,     // 滑块半径
        offset: 5,      // 容错偏差
        loadingText: 'Chờ chút...',
        failedText: 'Hãy thử lại',
        barText: 'Kéo sang để hoàn thành bức tranh',
        ...
        verify: function (arr, url) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    console.log("Kết quả trả về: " + ret)
                }
            });
            return ret;
        },
    ...
    _proto.initImg = function () {
        ...
        img.onerror = function () {
            ...
            if (loadCount >= that.options.maxLoadCount) {
                that.text.textContent = 'Không tải được hình ảnh';
