...
if (isset($_GET['g']) && ($_GET['g'] != "" )) {
    ...
    $loi_moi    = get_field('custom_invite', $postid);
                        ...
                        <div class="mui-col-md-8">
                            ...
                            <div class="mui-panel">
                                ...
                                <div class="wedding_content">
                                    <span class="diveditable content_editable" contenteditable=true oncut="return false" onpaste="return false" data-field="field_63ceb66556861" data-where="<?php echo $postid; ?>"><?php echo $noi_dung_1; ?></span>
                                    <span class="none_edit">Tên khách mời</span>
                                    <span class="diveditable content_editable" contenteditable=true oncut="return false" onpaste="return false" data-field="field_63ceb69856862" data-where="<?php echo $postid; ?>"><?php echo $noi_dung_2; ?></span>
                                    <span class="none_edit">Chú rể & Cô dâu</span>
                                    <span class="diveditable content_editable" contenteditable=true oncut="return false" onpaste="return false" data-field="field_63ceb6e956863" data-where="<?php echo $postid; ?>"><?php echo $noi_dung_3; ?></span>
                                    <span class="none_edit">Thời gian và địa điểm tổ chức</span>
                                    <span class="diveditable content_editable" contenteditable=true oncut="return false" onpaste="return false" data-field="field_610eb5f9cdc28" data-where="<?php echo $postid; ?>"><?php echo $loi_moi; ?></span>
                                </div>
                                <div class="guideline">
